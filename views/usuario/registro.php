        ...
        <form action="<?= base_url ?>usuario/save" method="post" class="row g-1">
          ...
          <div class="col-6">
            <div class="input-group mb-3">
              ...
              <input type="text" name="nombre" placeholder="Nombre" class="form-control" pattern="[A-Za-z]{1,32}" required>
            </div>
          </div>

          <div class="col-6">
            <input type="text" name="apellidos" placeholder="Apellido" class="form-control" pattern="[A-Za-z]{1,32}" required>
          </div>

...
<body class="d-flex flex-column h-100">
  ...
  <div class="textima">
    <div class="waveimg">
      <img src="<?= base_url ?>assets/img/log.png">
    </div>
    <div class="tipafo my-5 py-3">
      <h1>Dionysus</h1>
      <p>Plataforma de información para impulsar<br>los servicios de moteles en la ciudad de Ibagué</p>
    </div>
  </div>
